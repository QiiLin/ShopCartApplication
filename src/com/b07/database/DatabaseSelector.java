...
public class DatabaseSelector {
  ...
  protected static ResultSet getAllAccount(Connection connection) throws SQLException {
    Statement statement = connection.createStatement();
  ...
  protected static ResultSet getUserApproveAccounts(int userId, Connection connection)
      throws SQLException {
